...
namespace network {
  ...
  public:
    ...
    virtual void process(service::sptr sp,
      ...
      protocol::iq_info header_iq;
      bcopy(begin, &header_iq, sizeof(protocol::iq_info));
      begin += sizeof(protocol::iq_info);
      ...
      if (header_iq.sample_type() == 'I') {
        ...
        network::client::service_net_iq::sptr snp(network::client::service_net_iq::make(sp, header_iq));
